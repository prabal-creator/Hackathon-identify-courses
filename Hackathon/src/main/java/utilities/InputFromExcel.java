...
public class InputFromExcel {
    ...
    public static String searchInput() throws IOException {
        ...
        FileInputStream fs = new FileInputStream(userDir+"\\Hackathon(IC)\\Excel_Input\\SearchInput.xlsx");
    ...
    public static String[] businessInput() throws IOException {
        // get the excel file
        FileInputStream file = new FileInputStream(userDir+"\\Hackathon(IC)\\Excel_Input\\FormInput.xlsx");
